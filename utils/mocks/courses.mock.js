const coursesMock = [
  ...
  },
  {
    ...
    teacher: 10,
    classes: [2, 7, 9, 8, 8, 5, 8, 6, 7, 8, 2, 3, 6, 7, 8, 6, 2, 2, 4, 2],
    tags: [5, 9, 9, 5, 4, 4, 2],
    students: [22, 45, 28, 12, 2, 18, 48, 19, 25],
    description:
  ...
  },
  {
    ...
    name: 'Hustler White',
    teacher: 33,
    classes: [7, 3, 8, 6, 2, 5, 10, 8, 8, 10, 9, 9, 8, 4, 6, 10],
    tags: [7, 10, 2, 5, 6],
    students: [31, 9, 2, 13, 3, 32, 1, 6, 18, 35, 37, 11, 50],
    description:
      'hac habitasse platea dictumst maecenas ut massa quis augue luctus tincidunt nulla mollis molestie lorem quisque',
  },
  {
    id: 103,
    name: 'Gods Must Be Crazy II, The',
    teacher: 11,
    classes: [3, 9, 7, 5, 1, 4, 3, 9, 1, 8, 10, 8, 10, 5, 3, 10, 6, 6, 10],
    tags: [8, 8, 7, 10, 6, 8, 7, 9, 9, 9],
    students: [2, 6],
    description: 'non quam nec dui luctus rutrum nulla tellus in sagittis dui',
  },
  {
    id: 104,
    ...
    classes: [6, 8],
    tags: [5, 1, 2, 4],
    students: [39, 44, 1, 3, 6, 31, 35, 36, 9, 38, 3, 47, 17],
    description:
      'ac enim in tempor turpis nec euismod scelerisque quam turpis adipiscing lorem vitae mattis nibh ligula',
  },
  {
    id: 105,
    name: 'The Violent Professionals',
    teacher: 7,
    classes: [8, 1, 2, 1, 8, 3, 9, 5, 8, 2, 1, 1, 2, 9, 8, 10, 2],
    tags: [8, 9, 10, 4, 4],
    students: [37, 43, 43, 33, 27, 35, 50, 26, 26, 37, 34, 19, 44, 23],
    description:
  ...
  },
  {
    ...
    teacher: 6,
    classes: [9, 10, 2, 1, 5, 5, 1],
    tags: [6, 9, 8],
    students: [50, 18, 20, 26, 16, 46, 27, 27, 19, 21, 7, 24, 39, 1, 26, 46, 44, 28, 10],
    description:
  ...
  },
  {
    ...
    classes: [7, 8, 7],
    tags: [6],
    students: [9, 30, 4, 48, 23, 39, 41, 46, 26, 36, 41, 29, 19, 41, 9, 35, 34],
    description:
  ...
  },
  {
    ...
    teacher: 50,
    classes: [6, 5, 5, 7, 2, 10, 3, 5, 10, 10, 1],
    tags: [10, 3, 3, 7, 1, 2, 7, 7],
    students: [46, 24, 36, 34, 43, 48, 19, 8, 29, 32, 21, 32, 1, 38, 13, 15, 41, 7, 22, 16],
    description:
  ...
  {
    id: 109,
    name: 'Magic Flute, The (Trollflöjten)',
    teacher: 31,
    classes: [7, 3, 2, 4, 5, 5, 10, 4, 4, 7, 10, 6],
    tags: [4],
    students: [10, 8, 22, 21, 44, 32, 9, 40, 20, 1, 50, 21, 27, 4, 49, 12, 39, 16],
    description: 'pede malesuada in imperdiet et commodo vulputate justo in blandit ultrices enim lorem ipsum',
  },
  {
    id: 110,
  ...
  },
  {
    ...
    classes: [7],
    tags: [2, 1, 8, 3, 9],
    students: [48, 42, 20, 3, 26, 30, 15, 4, 34, 41, 1],
    description:
  ...
  },
  {
    ...
    name: 'Guncrazy',
    teacher: 32,
    classes: [6, 4, 10, 7, 3, 4, 4, 9, 4, 10, 3, 1],
    tags: [6],
    students: [29, 22, 24, 12, 20, 41, 41, 46, 38, 45, 27, 36, 24, 44, 8, 44, 8, 15, 13],
    description: 'vehicula consequat morbi a ipsum integer a nibh in quis justo maecenas',
  },
  {
    id: 113,
    name: 'Faithless (Trolösa)',
    teacher: 20,
    classes: [5, 2, 10, 3, 9, 3, 4, 5, 8, 8, 3, 6, 10, 4, 9, 5, 1, 7, 5],
    tags: [6, 10, 5, 2, 2, 4, 2, 7],
    students: [9, 33, 12, 50, 13, 49, 7, 24, 43, 11, 31, 26, 19, 28, 25],
  ...
  },
  {
    ...
    classes: [7],
    tags: [10, 9, 4],
    students: [42, 29, 28, 16, 18, 6, 9, 50, 42, 13, 50, 22, 2, 24, 35, 48, 39, 32, 10, 23],
    description:
  ...
  },
  {
    ...
    teacher: 2,
    classes: [10, 9, 9, 7, 4, 2, 10, 9, 3, 6, 9],
    tags: [5, 4, 1, 10],
    students: [30, 26, 2, 50, 34, 19, 18, 25, 30, 41, 40],
    description: 'turpis elementum ligula vehicula consequat morbi a ipsum integer a nibh in quis',
  },
  {
    id: 116,
    name: 'Manos: The Hands of Fate',
    teacher: 2,
    classes: [1, 4, 3, 10, 8, 2, 2, 2, 5],
    tags: [8, 10, 4, 6, 6, 5, 8, 8],
    students: [11, 24, 10, 43, 38, 46, 44, 21, 49, 46, 11, 21, 33, 5, 11, 23],
    description: 'turpis eget elit sodales scelerisque mauris sit amet eros suspendisse',
  },
  {
    id: 117,
    name: 'Bachelor Night',
    teacher: 16,
    classes: [5, 9, 5, 10, 3, 10, 9, 1, 5, 2, 7, 8, 7, 10, 9, 1, 10],
    tags: [2, 10],
    students: [11, 50, 13, 45, 39, 38, 7, 28, 11, 26, 39, 15, 5, 1, 26, 38, 48],
    description: 'dignissim vestibulum vestibulum ante ipsum primis in faucibus orci luctus et ultrices',
  },
  {
    id: 118,
    name: 'Far Side of the Moon, The (Face cachée de la lune, La)',
    teacher: 21,
    classes: [10, 1, 2, 1, 10, 4, 8, 3],
    tags: [2, 1],
    students: [14, 47, 17],
    description: 'enim sit amet nunc viverra dapibus nulla suscipit ligula in lacus curabitur at ipsum ac',
  },
  {
    id: 119,
    name: 'Stalin',
    teacher: 12,
    classes: [6, 4, 1, 6, 1, 5, 8, 5, 5, 5, 4, 6, 7, 5, 4, 7, 2, 9, 8, 6],
    tags: [2, 4],
    students: [18, 14, 2, 32, 37, 24, 4, 19, 20],
    description:
  ...
  },
  {
    ...
    classes: [8, 1, 8, 8, 2],
    tags: [9, 10, 1, 4, 5, 5],
    students: [6, 14, 30, 21, 23, 32, 11, 18, 27, 6, 7, 1, 22, 8, 35, 1, 6, 4],
    description: 'vestibulum sit amet cursus id turpis integer aliquet massa id lobortis convallis tortor',
  },
  {
    id: 121,
    name: "Assault, The (L'assaut)",
    teacher: 33,
    classes: [7, 4, 10, 7, 10],
    tags: [10, 3, 2, 3, 3, 1, 10, 7, 7, 8],
    students: [5, 14, 8, 11, 29, 26, 11, 4, 31, 15, 16, 43, 8, 32, 45, 49],
    description: 'morbi a ipsum integer a nibh in quis justo maecenas rhoncus aliquam lacus morbi quis tortor',
  },
  {
    id: 122,
    name: 'Cry, the Beloved Country',
    teacher: 38,
    classes: [7, 3, 5, 10, 5, 5, 2, 9, 1, 4, 2, 2],
    tags: [2, 6, 8, 4, 7, 4],
    students: [10, 31, 8, 13, 38, 18, 4],
    description: 'odio donec vitae nisi nam ultrices libero non mattis pulvinar',
  },
  {
    id: 123,
    name: 'Four Nights with Anna (Cztery noce z Anna)',
    teacher: 22,
    classes: [3, 1, 2, 3, 2, 5],
    tags: [10, 3, 5, 9, 7, 6],
    students: [27, 27, 31],
    description: 'donec odio justo sollicitudin ut suscipit a feugiat et eros vestibulum ac est lacinia nisi venenatis',
  },
  {
    id: 124,
    name: 'Prayer for the Dying, A',
    teacher: 16,
    classes: [2, 1, 8, 9, 7, 9, 3, 5, 1, 10, 3, 2, 3, 3, 10, 2, 4, 7, 1],
    tags: [6, 1, 6, 10, 9],
    students: [25, 18, 30, 4, 39, 42, 8, 43, 29, 32, 24, 12],
    description:
      'commodo vulputate justo in blandit ultrices enim lorem ipsum dolor sit amet consectetuer adipiscing elit',
  },
  {
    id: 125,
    name: 'Riding Alone for Thousands of Miles (Qian li zou dan qi)',
    teacher: 17,
    classes: [4, 8, 2, 5, 3, 2, 1, 8, 10, 2, 8, 6, 8, 9, 6, 4, 8, 8, 1, 9],
    tags: [2],
    students: [43, 1, 48, 12, 30, 35, 24, 1, 43, 23, 38],
    description: 'nonummy maecenas tincidunt lacus at velit vivamus vel nulla eget eros elementum pellentesque',
  },
  {
    id: 126,
    ...
    teacher: 27,
    classes: [3, 4, 6, 4, 6],
    tags: [4, 6, 10, 1, 7, 7, 3, 8, 2],
    students: [4, 20, 30, 14, 13, 25, 9, 33, 5, 24, 31, 15, 7, 44],
  ...
  },
  {
    ...
    teacher: 21,
    classes: [9, 5, 1, 5, 4, 9, 2, 9, 8, 1, 1, 9, 2, 9, 1, 10],
    tags: [3, 10],
    students: [32, 34, 17, 48, 40, 46, 21],
    description: 'pellentesque quisque porta volutpat erat quisque erat eros viverra eget congue eget semper',
  },
  {
    id: 128,
    name: 'La Première étoile',
    teacher: 4,
    classes: [7, 2, 10, 9, 10, 9, 9, 9, 3, 9, 3],
    tags: [5],
    students: [50, 22, 34, 5, 41, 48, 26, 7, 25, 6, 8, 27, 23, 5, 38, 36, 6, 8, 34],
    description:
      'maecenas tincidunt lacus at velit vivamus vel nulla eget eros elementum pellentesque quisque porta volutpat',
  },
  {
    id: 129,
    name: "Corman's World: Exploits of a Hollywood Rebel",
    teacher: 8,
    classes: [3, 8, 6, 5, 10, 10, 1, 7, 10, 7, 5, 1],
    tags: [2, 7, 2, 3, 8],
    students: [15, 1, 15],
  ...
  },
  {
    ...
    classes: [6],
    tags: [2, 5],
    students: [14, 30, 31, 34, 32, 34, 32, 13, 40, 9, 15, 5, 40, 25, 7, 8, 35, 39, 16, 49],
    description:
  ...
  },
  {
    ...
    name: 'Force of One, A',
    teacher: 21,
    classes: [7, 6, 5, 4, 2, 6, 2, 3, 8, 5, 8, 5, 4, 8, 10, 10, 2, 4],
    tags: [3, 2, 3, 2, 8, 2],
    students: [6, 12, 31, 12, 30, 33, 13, 11, 22, 40, 45, 15, 21, 12, 30, 3, 13, 44, 38],
    description: 'nunc commodo placerat praesent blandit nam nulla integer pede justo lacinia eget',
  },
  {
    id: 132,
    name: 'Stay Cool',
    teacher: 31,
    classes: [10, 8, 5, 4, 9, 6, 5, 3, 8, 10],
    tags: [8, 2, 9, 4, 5, 4, 8, 10, 3],
    students: [15, 2, 15, 29, 24, 3, 9, 44],
  ...
  },
  {
    ...
    name: 'Monte Carlo',
    teacher: 3,
    classes: [10, 10, 1, 4, 2, 5, 5, 1],
    tags: [4, 1, 10],
    students: [13, 41, 23, 27, 17],
    description:
  ...
  },
  {
    ...
    name: 'Eraser',
    teacher: 21,
    classes: [4, 6, 5, 7, 2, 4, 9, 1, 7, 5, 8, 2, 7, 1, 6, 10, 5, 7, 10],
    tags: [10, 1, 1],
    students: [26, 31, 18, 2, 36, 36, 5, 3, 22, 44],
    description:
  ...
  },
  {
    ...
    classes: [3, 4, 3, 1, 5, 2],
    tags: [7, 8, 9, 8, 10, 2, 6],
    students: [9, 33, 14, 24, 50, 25, 6, 34, 40, 42, 40, 42, 49, 50, 6, 8, 12, 47, 20],
    description: 'duis at velit eu est congue elementum in hac habitasse platea',
  },
  {
    id: 136,
    name: 'Lola Montès',
    teacher: 29,
    classes: [3, 3, 1, 8, 3, 5, 7, 5],
    tags: [10, 8, 7],
    students: [37, 38, 26, 2, 48, 28, 1, 33, 11],
  ...
  },
  {
    ...
    teacher: 31,
    classes: [7, 6],
    tags: [3, 8, 1, 8, 7, 7, 9, 2, 10],
    students: [30, 28, 37, 16, 22, 49, 13, 22, 22, 18, 6, 2, 43, 22, 41, 34, 12, 16, 43],
    description: 'libero nullam sit amet turpis elementum ligula vehicula consequat morbi a ipsum',
  },
  {
    id: 138,
    name: 'Striptease',
    teacher: 50,
    classes: [7, 2, 9, 1, 7, 5, 6, 4, 8],
    tags: [5, 1, 10, 6, 3, 10],
    students: [27, 17, 19, 11, 29, 1, 36, 45, 50, 13, 6, 43, 31, 44, 18, 20, 5, 7, 36],
  ...
  },
  {
    ...
    name: 'Monster House',
    teacher: 3,
    classes: [6, 9, 1, 8, 8, 8, 7],
    tags: [7, 9, 6, 9, 10, 5, 3],
    students: [47, 27, 11, 35],
    description:
      'duis at velit eu est congue elementum in hac habitasse platea dictumst morbi vestibulum velit id pretium iaculis',
  },
  {
    id: 141,
    name: 'Inbetweeners 2, The',
    teacher: 3,
    classes: [6, 1, 10, 8, 6, 2, 1, 6, 1, 5, 1, 4, 10, 8],
    tags: [4, 6, 7, 5, 6, 5],
    students: [29, 8],
    description: 'orci vehicula condimentum curabitur in libero ut massa volutpat convallis',
  },
  {
    id: 142,
    name: 'Alone for Christmas',
    teacher: 33,
    classes: [2, 1, 6, 3, 5, 2, 4, 2, 4],
    tags: [9, 6, 9, 4, 2, 1],
    students: [30, 44, 2, 45, 8, 17, 18, 30, 4, 13, 4, 7, 28, 42, 48],
    description:
  ...
  },
  {
    ...
    teacher: 45,
    classes: [9, 10, 10, 6, 10, 6, 9, 4, 2, 1, 5, 10, 7],
    tags: [2, 6, 3, 5, 5, 10, 1, 7, 2],
    students: [33, 7, 23, 50, 50, 6, 47, 3, 30, 14, 11, 12, 34],
    description: 'sed tristique in tempus sit amet sem fusce consequat nulla nisl nunc nisl',
  },
  {
    id: 144,
    name: 'Runaway',
    teacher: 30,
    classes: [9, 2, 5, 10, 6, 7, 2, 3, 7, 2, 7, 2, 8],
    tags: [3, 7, 8, 10, 3, 4],
    students: [22, 27, 37, 12, 35, 8, 30, 5, 29, 39, 25, 25, 32],
    description:
  ...
  },
  {
    ...
    classes: [5, 7, 9, 4, 7, 4],
    tags: [8, 5, 9, 10, 2, 3],
    students: [29, 45, 45, 10, 5, 15, 10, 13, 47, 32],
  ...
  },
  {
    ...
    name: 'Avalon',
    teacher: 14,
    classes: [8, 4, 7, 8, 9, 7, 4, 1, 1, 8],
    tags: [7, 6],
    students: [36, 33, 31, 27, 18, 15, 20, 10, 34, 20, 21, 33, 38, 3, 14, 24, 38],
    description: 'tellus nisi eu orci mauris lacinia sapien quis libero nullam sit amet turpis elementum ligula',
  },
  {
    id: 147,
    name: 'Enlighten Up!',
    teacher: 6,
    classes: [6, 10, 5, 9, 4, 1, 7, 1, 3, 7, 9, 6, 3, 10, 1, 6],
    tags: [3, 6, 2, 2, 3, 1, 3, 6, 6],
    students: [20, 27, 45, 3, 28],
    description:
      'quam fringilla rhoncus mauris enim leo rhoncus sed vestibulum sit amet cursus id turpis integer aliquet',
  },
  {
    id: 148,
    name: 'Cat Returns, The (Neko no ongaeshi)',
    teacher: 20,
    classes: [10, 3, 10, 1, 2, 5, 2, 5, 8, 9, 3, 5, 3, 10, 1, 9, 2, 5],
    tags: [6, 1, 5],
    students: [16, 19, 48, 16, 32, 1, 16, 10, 19, 16, 47, 45, 44, 48],
    description:
  ...
  },
  {
    ...
    teacher: 3,
    classes: [9, 1, 3, 5, 6, 2, 2, 8, 9, 8, 1, 3, 3, 5],
    tags: [3, 9, 6, 9, 8],
    students: [22, 31, 27, 13, 24, 19, 13, 4, 49, 2, 22, 25, 40, 43, 13, 31, 42, 37, 14],
    description:
  ...
  },
  {
    ...
    teacher: 42,
    classes: [9],
    tags: [1, 7, 8, 2, 6, 4, 2, 8, 2],
    students: [2, 19, 2, 10, 26, 33, 31, 26, 42, 50, 34, 22, 18, 2, 15, 1, 48],
